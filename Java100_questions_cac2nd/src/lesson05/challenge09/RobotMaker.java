...
class ClerRobot {
	void clerTable(int[] ingredients) {
...
public class RobotMaker {
	...
	public static void main(String[] args) throws IOException {
		...
		String str = robot.makeEggDishes(flourNum, sugarNum, eggNum, butterNum);
		...
		//（インスタンス名はclearRobot）
		//clearTableを実行する。
		ClerRobot clerRobot = new ClerRobot();
		clerRobot.clerTable(ingredients);
